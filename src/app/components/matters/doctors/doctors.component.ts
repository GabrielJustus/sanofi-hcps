...
@Component({
  ...
  styleUrls: ['./doctors.component.css', '../../animations.css', '../../tabs.css'],
})
export class DoctorsComponent implements OnInit {
  ...
  public doughnutChartData: MultiDataSet = [[140, 40, 30, 30]];
  ...
  public doughnutChartData3: MultiDataSet = [[42, 20, 17, 21]];
  ...
  section2ChartVertical = this.createVerticalBarChart([45, 30, 12, 10], ['TEXT', 'VIDEO', 'PRINTED MATERIALS', 'PODCASTS'], 90, true);
  ...
  toggleCollapsed1() {
    ...
    if (!this.isCollapsed)
      this.section2ChartVertical = this.createVerticalBarChart([45, 30, 12, 10], ['TEXT', 'VIDEO', 'PRINTED MATERIALS', 'PODCASTS'], 90, true);
  }
  ...
  toggleCollapsed10() {
    ...
    if (!this.isCollapsed10) {
      /* SECTION 3 CHARTS 1 */
      this.section3PainChart = this.createHorizontalBarChart([21, 14, 13], ['Efficacy', 'Product safety', 'Pain intensity'], 45);
